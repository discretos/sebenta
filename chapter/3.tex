...
É comum encontrarmos situações onde os elementos de um conjunto são também os
...
Quando queremos enfatizar que um conjunto $A$ é um subconjunto de um conjunto
